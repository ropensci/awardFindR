...
```
last_five_years <- awardFindR("keywords", sources="nih", from="2015-01-01", to="2020-01-01")

last_year <- awardFindR("keywords", sources="nih", from="2019-01-01", to="2020-01-01")
```
...
```
results <- awardFindR("keywords", sources="nih", from="2015-01-01")
```
